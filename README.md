...
这是一个使用 Vue3、TypeScript 和 AntD-Vue 构建的现代化前端项目，展示了如何在企业级应用中集成这些技术栈。项目包含了完整的用户认证、动态路由、权限管理、布局系统等企业级功能，可作为学习和开发的起点。后台数据地址：https://github.com/zzl110712/guardiaData
